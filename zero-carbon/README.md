...
[netcup.eu](https://www.netcup.eu/ueber-netcup/) is a European cloud provider.

From their [Green Electricity page](https://www.netcup.eu/ueber-netcup/oekostrom.php):

> netcup's own data centre is powered by electricity from renewable energy sources. A conscious decision has been made to avoid nuclear power and sources that are environmental CO2 polluters. netcup sources its energy from the power generated by flowing water. 

### tilaa.com

[tilaa](https://www.tilaa.com/) is a European cloud partner that actively tries to limit its impact on our environment.

From their [Conscious Cloud Hosting page](https://www.tilaa.com/en/vps/conscious-cloud-hosting):

>  Renewable energy is an essential condition for a sustainable future. That is why, all of our cloudservers are already powered by 100% renewable energy. The PUE is 1.2, which is lower than the market average. 

### scaleway.com

[scaleway.com](https://www.scaleway.com/) is a European cloud provider with datacenters in Paris, Amsterdam and Warsaw.

From their [About us page](https://www.scaleway.com/en/about-us/):
